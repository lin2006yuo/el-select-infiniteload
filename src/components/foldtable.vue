...
export default {
    data() {
        return {
            ...
            foldList: ['x_0', 'x_1'] // 该数组中的值 都会在列表中进行隐藏  死亡名单
        }
    },
    components: {},
    mounted(){
    ...
    methods: {
            ...
            *********************************/
            ...
            toggleFoldingClass (params) {
                ...
                : (this.foldList.indexOf(params.__identity) === -1 ? 'iconfont icon-minus-square-o' : 'iconfont icon-plussquareo')
            },
    }
};
</script>
